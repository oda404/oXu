            ...
            for (unsigned int i = 0; i < hitObjects.sliderVector.size(); i++)
            {
                if (hitObjects.sliderVector[i].getSliderType() == 'L')
                {
                    ...
                    else if (hitObjects.sliderApproachCircles[i].getApproachState())
                    {
                        ...
                        if (hitObjects.sliderVector[i].getSlides() == 0)
                        {
                            hitObjects.sliderVector.erase(hitObjects.sliderVector.begin() + i);
                            hitObjects.sliderApproachCircles.erase(hitObjects.sliderApproachCircles.begin() + i);
                        }
                    }
                }
                else if (hitObjects.sliderVector[i].getSliderType() == 'B')
                {
                    ...
                    {
                        window.draw(hitObjects.sliderVector[i].getHitCircle());
                        hitObjects.sliderVector[i].moveOnBezierSlider(0.1f, playField,dt ,hitObjects.sliderApproachCircles[i]);
