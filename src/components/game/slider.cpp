...
namespace oxu
{
   ...
   /* Public methods */
    ...
    Slider::Slider(unsigned int infoArr[4], const std::vector<Vector2<float>> &pControlPoints, const int &pLength, const uint8_t &pType, PlayField &playField):HitCircle(infoArr, playField)
    {
